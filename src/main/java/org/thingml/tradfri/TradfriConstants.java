...
/**
 * This class builds on the constants from project https://github.com/hardillb/TRADFRI2MQTT
 * (by r41d)
...
public class TradfriConstants {
    ...
    public static final String DATE_LAST_SEEN = "9020"; // Timestamp Epoch (seconds), The date the devive was seen ??? Not sure.
    public static final String DEVICE_REACHABLE = "9019"; // 0 or 1 seems to go to 0 after a few minutes if the device is not reachable
